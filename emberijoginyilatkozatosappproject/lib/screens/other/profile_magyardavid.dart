...
class ProfileDavidScreen extends StatefulWidget {
  @override
  _ProfileDavidScreenState createState() => _ProfileDavidScreenState();
}

class _ProfileDavidScreenState extends State<ProfileDavidScreen> {
  @override
                ...
                child: Column(
                  children: [
                    ...
                    const Padding(
                      ...
                      child: Center(
                        child: Text(
                          'My hobby is programming and the will to develop, although apart from programming, I like to practice various sports and exercise regularly in the gym.',
                          style: TextStyle(
