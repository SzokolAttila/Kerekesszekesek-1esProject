...
class Subpage3Screen extends StatefulWidget {
  @override
  _Subpage3ScreenState createState() => _Subpage3ScreenState();
}

class _Subpage3ScreenState extends State<Subpage3Screen> {
  int currentIndex = 0;
